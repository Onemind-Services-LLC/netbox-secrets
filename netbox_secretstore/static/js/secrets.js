$(document).ready(function() {
    ...
    function unlock_secret(secret_id) {
        $.ajax({
            url: netbox_api_path + 'plugins/secretstore/secrets/' + secret_id + '/',
            type: 'GET',
            dataType: 'json',
    ...
    function get_session_key(private_key) {
        ...
        $.ajax({
            url: netbox_api_path + 'plugins/secretstore/get-session-key/',
            type: 'POST',
            data: {
    ...
    $('#generate_keypair').click(function() {
        ...
        $.ajax({
            url: netbox_api_path + 'plugins/secretstore/generate-rsa-key-pair/',
            type: 'GET',
            dataType: 'json',
            success: function (response, status) {
